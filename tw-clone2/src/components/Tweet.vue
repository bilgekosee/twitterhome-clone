<template>
  <article class="tweet border-b border-red-900">
    <router-link to="#" class="flex p-4">
      ...
      <section class="flex-1">
        <div>
          ...
          <span class="text-red-900 ml-2 font-normal">
        ...
        <figure
          v-if="tweet.image"
          class="rounded-xl border border-red-900 overflow-hidden"
        >
          <img
            :src="tweet.image.url"
            :alt="tweet.image.alt"
          ...
          <div class="text-gray-500">
            <i
              class="
                ...
                mr-1
                rounded-full
                hover:bg-red-900 hover:text-red-500
              "
            ></i>
